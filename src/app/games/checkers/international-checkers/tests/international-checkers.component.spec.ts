...
xdescribe('even archive InternationalCheckersComponent', () => {
    ...
    describe('first click', () => {
        ...
        it('should highlight possible step-landing after selecting normal piece', fakeAsync(async() => {
            ...
            // And the other one should not exist
            testUtils.expectElementNotToExist('#clickable-highlight-1-5');
            testUtils.expectElementNotToExist('#clickable-highlight-3-5');
            testUtils.expectElementNotToExist('#clickable-highlight-9-5');
        }));
